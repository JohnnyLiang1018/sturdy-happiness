...
class TorchTrainer(Trainer, metaclass=abc.ABCMeta):
    ...
    def train_exp(self, np_batch_sim, np_batch_sim_, np_batch_real, tuning, num_epoch, old_appr):
        self._num_train_steps += 1
        ...
        self.train_from_torch_exp(batch_sim, batch_sim_, batch_real, tuning, old_appr, num_epoch)
