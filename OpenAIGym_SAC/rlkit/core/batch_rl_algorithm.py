            ...
            for _ in range(self.num_train_loops_per_epoch):
                ...
                for _ in range(self.num_trains_per_train_loop):
                    if count > self.num_epochs / 2:
                        ...
                        train_data_sim = self.replay_buffer.random_batch(round(self.batch_size - self.batch_size*0.2))
                        # train_data_real_ = self.replay_buffer_real.random_sub_batch(epoch_num*100 + 6000, round(self.batch_size*0.3))
                        train_data_sim_ = self.replay_buffer.random_batch(round(self.batch_size*0.2))
                        train_data_real = self.replay_buffer_real.random_sub_batch(epoch_num*100 + 1000, round(self.batch_size*0.2))
